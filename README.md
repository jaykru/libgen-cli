...
libgen-cli is a command line interface application which allows users
to quickly query the Library Genesis dataset and download any of its
contents.

This fork is a quick and dirty fix; the old version used broken
download mirrors. Currently, libgen-cli will always download from the
super-fast Cloudflare IPFS Gateway. It works, and is able to download
books in my experience. That said, it should be considered practically
abandoned. If you poke me enough, I will probably fix it when it
breaks. If you have interest in maintaining this tool, please fork it!
...
```bash
$ go get -u github.com/jaykru/libgen-cli
$ go install github.com/jaykru/libgen-cli
```
